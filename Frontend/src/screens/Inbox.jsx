...
export default function Inbox() {
  ...
  const InboxCard = ({item})=>{
      ...
      return <View style={{  flexDirection:'row', justifyContent:'space-between', alignItems:'center', padding:scale(10), borderBottomColor:appColors.gray, borderBottomWidth:1 }} >
